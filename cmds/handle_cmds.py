...
from config.cmds_cfg import (SET_PLAYERS_COMMAND, HELP_COMMAND,
                             OVERWATCH_AGENTS_COMMAND, GET_PLAYERS_COMMAND)
...
async def handle_command(message):
    ...
    log.info("MSG_PARTS: %s", msg_parts)
    ...
    if len(msg_parts) == 1:
        ...
        elif spec_cmd.lower() == OVERWATCH_AGENTS_COMMAND.lower(): # ow-agents
